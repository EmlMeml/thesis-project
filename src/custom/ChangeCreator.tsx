  ...
  return (
    <div id="change-creator" className="change-creator">
        ...
        <div id="change-description-container">
            ...
            <textarea id="change-description" className="change-elements" placeholder="Enter your change description here..." rows={5}></textarea>
        </div>
        ...
        <div id="change-intensity-container" className="change-elements">
            ...
            <input type="range" id="change-intensity"  min="1" max="5" defaultValue="3" />
        </div>
